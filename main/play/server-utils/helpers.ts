...
export function isUsernameUnique(name: string) {
    var isUnique = true;
    var i;
...
export function getConnectionForID(id: number) {
    var connect = null;
    var i;
...
export function makeUserListMessage() {
    var userListMsg = {
        type: "userlist",
        users: [] as string[],
    };
...
export function sendUserListToAll() {

...
Service details:
- app: Implements a basic UI (index.html) for the user to interact with backend services; an HTTP server (app.js and res.js) handling requests and returning responses; and a WebSocket client object for accessing the API to interact with WebSocketServers in connected backend services.
